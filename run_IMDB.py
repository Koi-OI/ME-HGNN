...
from model import MEHGNN_nc_AC

ap = argparse.ArgumentParser(description='ME-HGNN testing for the IMDB dataset')
...
etypes_lists = [[[0, 1], [2, 3]],
                [[1, 0], [1, 2, 3, 0]],
                [[3, 2], [3, 0, 1, 2]]] # MDM MAM DMD DMAMD AMA AMDMA
num_metapaths = [2, 2, 2]
num_edge_type = 4
src_node_type = 0
...
for cur_repeat in range(repeat):
    ...
    net = MEHGNN_nc_AC(num_layers, num_metapaths, num_edge_type, etypes_lists, in_dims, emb_dim, hidden_dim,
