...
ap = argparse.ArgumentParser(description='ME-HGNN testing for the DBLP dataset')
...
# 0-AP 1-PA 2-PT 3-TP 4-PV 5-VP
etypes_list = [[0, 1], [0, 2, 3, 1], [0, 4, 5, 1]] #APA APTPA APVPA
num_metapaths = 3
num_edge_type = 6
src_node_type = 1
