...
from model.MEHGNN_nc_mb import MEHGNN_nc_mb_AC

ap = argparse.ArgumentParser(description='ME-HGNN testing for the ACM dataset')
...
ap.add_argument('--feats-drop-rate', type=float, default=0.3, help='The ratio of attributes to be dropped. Default is 0.3.')
...
for cur_repeat in range(repeat):
    ...
    net = MEHGNN_nc_mb_AC(num_metapaths, num_edge_type, etypes_list, in_dims, emb_dim, hidden_dim, out_dim,
