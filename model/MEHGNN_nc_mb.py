...
class MEHGNN_nc_mb_layer(nn.Module):
    def __init__(self,
                 num_metapaths,
                 num_edge_type,
                 etypes_list,
                 ...
                 rnn_type='gru',
                 attn_drop=0.5):
        super(MEHGNN_nc_mb_layer, self).__init__()
        self.in_dim = in_dim
        ...
        self.ctr_ntype_layer = MEHGNN_ctr_ntype_specific(num_metapaths,
                                                        etypes_list,
                                                        in_dim,
                                                        num_heads,
                                                        attn_vec_dim,
...
class MEHGNN_nc_mb_AC(nn.Module):
    def __init__(self,
                 num_metapaths,
                 num_edge_type,
                 etypes_list,
                 ...
                 is_cuda=False,
                 feat_opt=[]):
        super(MEHGNN_nc_mb_AC, self).__init__()
        ...
        # MEHGNN_nc_mb layers
        self.layer1 = MEHGNN_nc_mb_layer(num_metapaths,
                                        num_edge_type,
                                        etypes_list,
                                        hidden_dim,
                                        out_dim,
