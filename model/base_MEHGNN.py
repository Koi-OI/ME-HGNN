...
class MEHGNN_metapath_specific(nn.Module):
    def __init__(self,
                 etypes,
                 out_dim,
                 num_heads,
                 ...
                 use_minibatch=False,
                 attn_switch=False):
        super(MEHGNN_metapath_specific, self).__init__()
...
class MEHGNN_ctr_ntype_specific(nn.Module):
    def __init__(self,
                 num_metapaths,
                 etypes_list,
                 out_dim,
                 ...
                 attn_drop=0.5,
                 use_minibatch=False):
        super(MEHGNN_ctr_ntype_specific, self).__init__()
        self.out_dim = out_dim
        self.num_heads = num_heads
        self.use_minibatch = use_minibatch
        ...
        for i in range(num_metapaths):
            self.metapath_layers.append(MEHGNN_metapath_specific(etypes_list[i],
                                                                out_dim,
                                                                num_heads,
                                                                rnn_type,
                                                                r_vec,
